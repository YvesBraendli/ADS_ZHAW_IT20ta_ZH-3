...
public class ServerGraphics {
  ...
  public void drawLine(double x1, double y1, double x2, double y2) {
    b.append("<line x1=\"");
    b.append(Double.toString(round(x1)));
    b.append("\" y1=\"");
    b.append(Double.toString(round(y1)));
    b.append("\" x2=\"");
    b.append(Double.toString(round(x2)));
    b.append("\" y2=\"");
    b.append(Double.toString(round(y2)));
    b.append("\"/>\n");
  }
  ...
  public void drawRect(double x, double y, double w, double h) {
    ...
    b.append("\" ");
    b.append("width=\"");
    b.append(Double.toString(round(w)));
    b.append("\" height=\"");
    b.append(Double.toString(round(h)));
    b.append("\" style=\"draw\" />\n");
  }
